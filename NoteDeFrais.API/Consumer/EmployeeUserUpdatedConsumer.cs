...
{
    public class EmployeeUserUpdatedConsumer : IConsumer<EmployeeUserUpdated>
    {
        public readonly IEmployeeServices consumerService;
        public EmployeeUserUpdatedConsumer(IEmployeeServices consumerService)
        {
            this.consumerService = consumerService;
        }
        public async Task Consume(ConsumeContext<EmployeeUserUpdated> context)
        {
